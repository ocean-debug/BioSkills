---
name: bio-workflows-variant-to-report
description: "Coordinate variant filtering, annotation, and reporting-oriented interpretation into a traceable reporting workflow."
version: 0.1.0
tags: ["workflow", "variants", "reporting", "clinical"]
trigger_keywords: ["variant to report", "variant reporting workflow", "clinical variant workflow", "annotated VCF to report"]
metadata:
  openclaw:
    requires:
      bins: []
...
# Variant to report workflow

## Purpose / When To Use

- Coordinate variant filtering, annotation, and reporting-oriented interpretation into a traceable reporting workflow.
- Use this skill when the user needs variant to report workflow in the context of variant calling.
